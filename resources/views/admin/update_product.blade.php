...
<body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <a class="navbar-brand" href="index.html">Halaman</a>
            ...
            <div class="col-md-6 mx-auto mt-4">
                <div class="card">
                    <div class="card-header">
                        <h3 style="text-center">Edit Data Penjualan Ikan</h3>
                    </div>
                    <div class="card-body">
                        <form action="{{ url('/update_product_confirm',$product->id) }}" method="post" enctype="multipart/form-data">
                        @csrf
                            <div class="mb-2">
                                <label for="nrp" class="form-label">Nama Ikan:</label>
                            ...
                            <div class="mb-2">
                                ...
                                <input type="text" class="form-control" name="description" id="description" required value="{{$product->description}}">
                            </div>
                            ...
                            <div class="mb-2">
                                <label for="jurusan" class="form-label">Satuan: </label>
                                <input type="text" class="form-control" name="discount_price" id="discount_price" required value="{{$product->discount_price}}">
                            </div>

                            <div class="mb-2">
                                <label for="gambar" class="form-label">Stok: </label>
                                <input class="form-control" name="quantity" id="quantity" required value="{{$product->quantity}}">
                            </div>
                            <div class="mb-2">
                                <label for="gambar" class="form-label">Jenis Ikan: </label>
                            ...
                            <div class="mb-2">
                                <label for="gambar" class="form-label">Change Image: </label>
                                <input type="file" class="form-control" name="image" required value="{{$product->image}}">
                            </div>

                            <div class="mb-2">
                                <button type="submit" value="Add Product" class="btn btn-primary" name="submit">Update Data</button>
                            </div>
                        </form>
                    </div>
                </div>
