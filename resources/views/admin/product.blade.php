            ...
            <div class="col-md-6 mx-auto mt-4">
                <div class="card">
                    <div class="card-header">
                        <h3 style="text-center">Tambah Data Penjualan Ikan</h3>
                    </div>
                    <div class="card-body">
                        ...
                        @csrf
                            ...
                            <div class="mb-2">
                                ...
                                <option value="" selected="">Tambah Jenis Ikan</option>
                            ...
                            <div class="mb-2">
                                <label for="gambar" class="form-label">Foto Ikan: </label>
                                <input type="file" class="form-control" name="image" required>
                            </div>

                            <div class="mb-2">
                                <button type="submit" value="Add Product" class="btn btn-primary" name="submit">Tambah Data</button>
                            </div>
                        </form>
                    </div>
                </div>
