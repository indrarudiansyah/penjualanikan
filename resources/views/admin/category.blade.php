                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="{{ url('view_category') }}">Jenis Ikan</a>
                            <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseLayouts" aria-expanded="false" aria-controls="collapseLayouts">
                                <div class="sb-nav-link-icon"><i class="fas fa-columns"></i></div>
                                Ikan Hias
                                <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
                            </a>
                                    <a class="nav-link" href="{{ url('view_product') }}">Tambah Data Penjualan Ikan</a>
                    ...
                    <div class="container-fluid">
                        ...
                        <form action="{{ url('/add_category') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-2">
                                ...
                                <input type="text" class="form-control" name="category" id="kategori" placeholder="Tambah Jenis Ikan">
                            </div>

                            <div class="mb-2">
                                <button type="submit" class="btn btn-primary" name="submit" value="Add Category">Tambah</button>
                            </div>
                        </form>
                    </div>
